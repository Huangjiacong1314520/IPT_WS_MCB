...
//Uint8 hostDescriptor_SL2[SL2_HOST_DESCRIPTOR_NUM][GE_DESCRIPTOR_SIZE];//96*32
//
...
//Uint8 packetBuffer_SL2_Size0[SL2_SIZE0_PKT_BUF_NUM][SL2_PACKET_BUFFER_SIZE0];//64*1536
//Uint8 packetBuffer_SL2_Size1[SL2_SIZE1_PKT_BUF_NUM][SL2_PACKET_BUFFER_SIZE1];//32*10*1024
//
//#pragma DATA_SECTION(hostDescriptor_LL2,"QMSS_Data.Descriptor_LL2")
//#pragma DATA_ALIGN (hostDescriptor_LL2, 64)
//Uint8 hostDescriptor_LL2[LL2_HOST_DESCRIPTOR_NUM][GE_DESCRIPTOR_SIZE];//96*32
//
...
//Uint8 packetBuffer_LL2_Size0[LL2_SIZE0_PKT_BUF_NUM][LL2_PACKET_BUFFER_SIZE0];//32*1536
//Uint8 packetBuffer_LL2_Size1[LL2_SIZE1_PKT_BUF_NUM][LL2_PACKET_BUFFER_SIZE1];//16*10*1024

#pragma DATA_SECTION(hostDescriptor_DDR,"QMSS_Data.Descriptor_DDR")
#pragma DATA_ALIGN (hostDescriptor_DDR, 128)
Uint8 hostDescriptor_DDR[DDR_HOST_DESCRIPTOR_NUM][GE_DESCRIPTOR_SIZE];//768*32
...
Uint8 packetBuffer_DDR_Size0[DDR_SIZE0_PKT_BUF_NUM][DDR_PACKET_BUFFER_SIZE0];//512*1536
Uint8 packetBuffer_DDR_Size1[DDR_SIZE1_PKT_BUF_NUM][DDR_PACKET_BUFFER_SIZE1];//256*10*1024
...
#pragma DATA_SECTION(uiaDescriptorAccumulationList,"PacketRecvData")
...
void GE_PktDMA_init()
{
	...
	KeyStone_pktDma_configureRxFlow(&gpNetCP_DMA_RxFlowCfgRegs->RX_FLOW_CONFIG[GE_DIRECT_RX_PORT1_CHANNEL], flowCfgTable, uiUsedRxFlowNum);
