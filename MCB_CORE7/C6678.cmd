...
MEMORY
{
    ...
    SYS_VER:		 o = 0x80000000 l = 0x00010000   /* 64kB DDR3 SDRAM for CORE0 */
  	US422:     		 o = 0x80010000 l = 0x00010000   /* 64kB DDR3 SDRAM for CORE0 */
  	HDSYNC:    		 o = 0x80020000 l = 0x00010000   /* 64kB DDR3 SDRAM for CORE0 */
	RS422:     		 o = 0x80030000 l = 0x00010000   /* 64kB DDR3 SDRAM for CORE0 */
	CAN0:			 o = 0x80040000 l = 0x00010000   /* 64kB DDR3 SDRAM for CORE0 */
	CAN1:			 o = 0x80050000 l = 0x00010000   /* 64kB DDR3 SDRAM for CORE0 */
	CAMLINK:		 o = 0x80060000 l = 0x000A0000   /* 640kB DDR3 SDRAM for CORE0 */
	PIC:			 o = 0x80100000 l = 0x03700000   /* 55MB DDR3 SDRAM for CORE0 */

	COMMIT_DATA_DDR3:	o = 0x83800000 l = 0x00001F40	/* 用于存放上传信息 */
	COMMIT_DATA1_DDR3:  o = 0x83801F40 l = 0x00000280
	DIRTY_DDR3:		 o = 0x838021C0 l = 0x000FDE40
	FREE_DDR3:	 	 o = 0x83900000 l = 0x0C700000	 /* 共享DDR3 */
    CORE0_DDR3:      o = 0x90000000 l = 0x10000000   /* 256MB DDR3 SDRAM for CORE1 */
    CORE1_DDR3:      o = 0xA0000000 l = 0x10000000   /* 256MB DDR3 SDRAM for CORE2 */
    CORE2_DDR3:      o = 0xB0000000 l = 0x10000000   /* 256MB DDR3 SDRAM for CORE3 */
    CORE3_DDR3:      o = 0xC0000000 l = 0x10000000   /* 256MB DDR3 SDRAM for CORE4 */
    CORE4_DDR3:      o = 0xD0000000 l = 0x10000000   /* 256MB DDR3 SDRAM for CORE5 */
    CORE5_DDR3:      o = 0xE0000000 l = 0x08000000   /* 256MB DDR3 SDRAM for CORE6 */
    CORE6_DDR3:      o = 0xE8000000 l = 0x08000000   /* 256MB DDR3 SDRAM for CORE6 */
...
SECTIONS
{
#ifdef CORE0
    .text          >  CORE0_DDR3
    .stack         >  CORE0_L2_SRAM   //CORE0_L2_SRAM
    .bss           >  CORE0_DDR3
    .cio           >  CORE0_DDR3
    .const         >  CORE0_DDR3
    ...
    .csl_vect      >  CORE0_DDR3 						// 	CORE0_L2_SRAM
	QMSS_Data.Descriptor_DDR 	> 	CORE0_DDR3 			//	网口报文描述信息
	PacketData.buffer_DDR 		> 	CORE0_DDR3 			//	网口报文缓存
	DESCMEM_BUFFER_SEND         >   CORE0_DDR3 			//	LWIP协议栈发送报文缓存
	PacketRecvData              >   CORE0_DDR3  		//	CORE0_L2_SRAM//网口接收数据缓存，只能放在L2上
	AuroraCode                  >   CORE0_L2_SRAM 		//	CORE0_L2_SRAM
	AuroraData                  >   CORE0_L2_SRAM 		//	CORE0_L2_SRAM
	DownloadData				>   CORE0_DDR3			// 	VxWorks配置信息
#endif
    ...
    .csl_vect      >  CORE7_L2_SRAM
	AuroraCode     >  CORE7_L2_SRAM
	AuroraData     >  CORE7_L2_SRAM
    CommitData     >  COMMIT_DATA_DDR3
    CommitData_1   >  COMMIT_DATA1_DDR3
#endif
}
